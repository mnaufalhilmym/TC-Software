...
function timer1() {
    if (millisecond1 == 0) {            //MAX 999ms*
        millisecond1 = 99;
        if (second1 == 0) {             //MAX 59s*
            second1 = 59;
            if (minute1 == 0) {         //MAX 4s*
                stop1();
            } else {
            ...
            if (second1 <= 6 && minute1 == 3 && autoTimer2) {
                popup();
            }
            second1--;
        }
...
function timer2() {
    if (millisecond2 == 99) {       //MAX 999ms*
        millisecond2 = 0;
        if (second2 == 59) {        //MAX 59s*
            second2 = 0;
            if (minute2 == 3) {     //MAX 3s*
                stop2();
            } else {
...
function popup() {
    ...
    if(second1 == 1){
        ...
        modal.style.display = "none";
    } else if (second1 > 1 && second1 <= 4){
        if (second1 == 4) {
            countdownAudio.play();
        }
        document.getElementById("tigadetik").innerHTML = (second1-1) + " seconds left";
    }
}
